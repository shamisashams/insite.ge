                ...
                <div class="display-flex media">
                    <div class="media-body">
                        <h6 class="media-heading">
                            <span class="users-view-name">{{$slider->title}} </span>
                        </h6>
                    </div>
                </div>
            </div>
            <div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                <a href="{{locale_route('slider.edit',$slider->id)}}" class="btn-small indigo">
                    @lang('admin.edit')
                </a>
                <a class="btn-small -settings waves-effect -light -btn right ml-3"
                   href="{{locale_route('slider.destroy',$slider->id)}}"
                ...
                <div class="col s12 m4">
                    <table class="striped">
                        ...
                        <tr>
                            ...
                            <td>{{\Carbon\Carbon::parse($slider->created_at)}}</td>
                        </tr>
                        <tr>
                            <td>@lang('admin.updated_at')</td>
                            <td>{{\Carbon\Carbon::parse($slider->updated_at)}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
