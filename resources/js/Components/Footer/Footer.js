        ...
        <div className="flex footer_content">
          <div className="flex locations">
            ...
            <div>
              ...
              <div className="flex">
                <img src="/images/icons/footer/1.svg" alt="" />
                <p>
                  1604 Virginia Street. <br /> Tbilisi, Georgia
                </p>
              </div>
              <div className="flex">
                <img src="/images/icons/footer/2.svg" alt="" />
          ...
          <div className="flex links">
            ...
            <div className="column" style={{ margin: 0 }}>
              ...
              <InLink href="/services/planning" text="Планировка" />
              <InLink href="/services/web-development" text="Веб Разработки" />
              <InLink href="/services/design" text="UI/UX Дизайн" />
              <InLink href="/services/virtualization" text="Виртуализация" />
              <InLink href="/services/remote-work" text="Удалённая Работа" />
              <InLink href="/services/security" text="Сетевая Безопасность" />
            </div>
            <div className="column">
              <Link href="/">
