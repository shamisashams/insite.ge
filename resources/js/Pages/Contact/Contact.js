...
import { MapGeo, MapRus } from "../../Components/Map";
import "./Contact.css";
...
const Contact = () => {
    const meta = Meta(
        "Insite - კონტაქტი",
        "კომპანიის შესახებ, საიტების შექმნა, საიტის შექმნა, საიტის შეცვლა, საიტის გადატანა",
        "დაგვიკავშირდით თუ რაიმე შეკითხვები გაქვთ"
    );
